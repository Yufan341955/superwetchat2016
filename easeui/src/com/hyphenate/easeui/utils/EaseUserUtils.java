...
public class EaseUserUtils {
    ...
    public static void setAppUserAvatar(Context context, String username, ImageView imageView){
       User user = getAppUserInfo(username);
        ...
        if(user != null && user.getAvatar() != null){
            ...
            Glide.with(context).load(R.drawable.default_nor_avatar).into(imageView);
        }
    }
    ...
    public static void setGrouprAvatar(Context context, String hxid, ImageView imageView){
    ...
    public static void setCurrentAppNick(TextView textView) {
        String username=EMClient.getInstance().getCurrentUser();
